...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-campaignAgents">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.agent.fields.campaign') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
...
@endcan
  ...
  let table = $('.datatable-campaignAgents:not(.ajaxTable)').DataTable({ buttons: dtButtons })
