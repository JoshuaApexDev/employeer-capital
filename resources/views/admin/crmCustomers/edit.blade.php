            ...
            <form method="POST" action="{{ route("admin.crm-customers.update", [$crmCustomer->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('cellphone') ? 'is-invalid' : '' }}" type="text"
                           name="cellphone" id="cellphone" value="{{ old('cellphone', $crmCustomer->cellphone) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text"
                           name="address" id="address" value="{{ old('address', $crmCustomer->address) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text"
                           name="country" id="country" value="{{ old('country', $crmCustomer->country) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('zip_code') ? 'is-invalid' : '' }}" type="text"
                           name="zip_code" id="zip_code" value="{{ old('zip_code', $crmCustomer->zip_code) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('file_code') ? 'is-invalid' : '' }}" type="text"
                           name="file_code" id="file_code" value="{{ old('file_code', $crmCustomer->file_code) }}">
                ...
                @for($i = 1;$i <= 10;$i++)
                    @php
                        ...
                        $field = $crmCustomer->$customField;
                    @endphp
                    <div class="form-group">
                        <label for="custom_field_{{$i}}">Custom Field {{$i}}</label>
                        <input class="form-control {{ $errors->has($customField) ? 'is-invalid' : '' }}" type="text"
                               name="{{$customField}}" id="{{$customField}}" value="{{ old($customField, $field) }}">
                        @if($errors->has($customField))
                            <div class="invalid-feedback">
                                {{ $errors->first($customField) }}
                            </div>
                        @endif
                    </div>
                @endfor
