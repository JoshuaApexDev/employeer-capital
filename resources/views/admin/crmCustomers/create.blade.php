        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.crm-customers.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control required {{ $errors->has('description') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control required {{ $errors->has('living_with') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control required {{ $errors->has('dependents') ? 'is-invalid' : '' }}" name="dependents"
                            id="dependents">
                        <option value
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nationality') ? 'is-invalid' : '' }}" type="text"
                           name="nationality" id="nationality" value="{{ old('nationality', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control required {{ $errors->has('marital_status') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('ssn') ? 'is-invalid' : '' }}" type="text" name="ssn"
                           id="ssn" value="{{ old('ssn', '') }}">
                    @if($errors->has('ssn'))
                        <div class="invalid-feedback">
                            {{ $errors->first('ssn') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('health_status') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('chronic_illness') ? 'is-invalid' : '' }}" type="text"
                           name="chronic_illness" id="chronic_illness" value="{{ old('chronic_illness', '') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('goal_in_life') ? 'is-invalid' : '' }}"
                              name="goal_in_life" id="goal_in_life">{{ old('goal_in_life') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('elementary_school_name') ? 'is-invalid' : '' }}"
                           type="text" name="elementary_school_name" id="elementary_school_name"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('elementary_graduate_date') ? 'is-invalid' : '' }}"
                           type="text" name="elementary_graduate_date" id="elementary_graduate_date"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('middle_school_name') ? 'is-invalid' : '' }}" type="text"
                           name="middle_school_name" id="middle_school_name"
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        type="text" name="middle_school_graduate_date" id="middle_school_graduate_date"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('high_school_name') ? 'is-invalid' : '' }}" type="text"
                           name="high_school_name" id="high_school_name" value="{{ old('high_school_name', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('high_school_graduate_date') ? 'is-invalid' : '' }}"
                           type="text" name="high_school_graduate_date" id="high_school_graduate_date"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('college_name') ? 'is-invalid' : '' }}" type="text"
                           name="college_name" id="college_name" value="{{ old('college_name', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('college_graduate_date') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('career') ? 'is-invalid' : '' }}" type="text"
                           name="career" id="career" value="{{ old('career', '') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('lived_in_usa') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('speak_english') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('english_level') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('written_english') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('father_age') ? 'is-invalid' : '' }}" type="number"
                           name="father_age" id="father_age" value="{{ old('father_age', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mother_age') ? 'is-invalid' : '' }}" type="number"
                           name="mother_age" id="mother_age" value="{{ old('mother_age', '') }}" step="1">
                ...
                <div class="form-group">
                    <label
                        for="emergency_contact_name">{{ trans('cruds.crmCustomer.fields.emergency_contact_name') }}</label>
                    <input class="form-control {{ $errors->has('emergency_contact_name') ? 'is-invalid' : '' }}"
                           type="text" name="emergency_contact_name" id="emergency_contact_name"
                    ...
                    @endif
                    <span
                        class="help-block">{{ trans('cruds.crmCustomer.fields.emergency_contact_name_helper') }}</span>
                </div>
                <div class="form-group">
                    <label
                        for="emergency_contact_relationship">{{ trans('cruds.crmCustomer.fields.emergency_contact_relationship') }}</label>
                    <input class="form-control {{ $errors->has('emergency_contact_relationship') ? 'is-invalid' : '' }}"
                           type="text" name="emergency_contact_relationship" id="emergency_contact_relationship"
                    ...
                    @endif
                    <span
                        class="help-block">{{ trans('cruds.crmCustomer.fields.emergency_contact_relationship_helper') }}</span>
                </div>
                <div class="form-group">
                    <label for="reference_name_1">{{ trans('cruds.crmCustomer.fields.reference_name_1') }}</label>
                    <input class="form-control {{ $errors->has('reference_name_1') ? 'is-invalid' : '' }}" type="text"
                           name="reference_name_1" id="reference_name_1" value="{{ old('reference_name_1', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('reference_relationship_1') ? 'is-invalid' : '' }}"
                           type="text" name="reference_relationship_1" id="reference_relationship_1"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('reference_phone_1') ? 'is-invalid' : '' }}"
                           type="number" name="reference_phone_1" id="reference_phone_1"
                           value="{{ old('reference_phone_1', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('reference_name_2') ? 'is-invalid' : '' }}" type="text"
                           name="reference_name_2" id="reference_name_2" value="{{ old('reference_name_2', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('reference_relationship_2') ? 'is-invalid' : '' }}"
                           type="text" name="reference_relationship_2" id="reference_relationship_2"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('reference_phone_2') ? 'is-invalid' : '' }}"
                           type="number" name="reference_phone_2" id="reference_phone_2"
                           value="{{ old('reference_phone_2', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('reference_name_3') ? 'is-invalid' : '' }}" type="text"
                           name="reference_name_3" id="reference_name_3" value="{{ old('reference_name_3', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('reference_relationship_3') ? 'is-invalid' : '' }}"
                           type="text" name="reference_relationship_3" id="reference_relationship_3"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('reference_phone_3') ? 'is-invalid' : '' }}"
                           type="number" name="reference_phone_3" id="reference_phone_3"
                           value="{{ old('reference_phone_3', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('company_name_1') ? 'is-invalid' : '' }}" type="text"
                           name="company_name_1" id="company_name_1" value="{{ old('company_name_1', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('company_phone_1') ? 'is-invalid' : '' }}" type="number"
                           name="company_phone_1" id="company_phone_1" value="{{ old('company_phone_1', '') }}"
                           step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('worked_from_1') ? 'is-invalid' : '' }}" type="text"
                           name="worked_from_1" id="worked_from_1" value="{{ old('worked_from_1') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('worked_until_1') ? 'is-invalid' : '' }}"
                           type="text" name="worked_until_1" id="worked_until_1" value="{{ old('worked_until_1') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('reason_for_leaving_1') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('company_name_2') ? 'is-invalid' : '' }}" type="text"
                           name="company_name_2" id="company_name_2" value="{{ old('company_name_2', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('company_phone_2') ? 'is-invalid' : '' }}" type="number"
                           name="company_phone_2" id="company_phone_2" value="{{ old('company_phone_2', '') }}"
                           step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('worked_from_2') ? 'is-invalid' : '' }}" type="text"
                           name="worked_from_2" id="worked_from_2" value="{{ old('worked_from_2') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('worked_until_2') ? 'is-invalid' : '' }}"
                           type="text" name="worked_until_2" id="worked_until_2" value="{{ old('worked_until_2') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('reason_for_leaving_2') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('office_skills') ? 'is-invalid' : '' }}"
                              name="office_skills" id="office_skills">{{ old('office_skills') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('when_start') ? 'is-invalid' : '' }}" type="text"
                           name="when_start" id="when_start" value="{{ old('when_start') }}">
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('official_valid') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="official_valid" id="official_valid"
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('birth_certificate') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="birth_certificate" id="birth_certificate"
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('have_curp') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="have_curp" id="have_curp"
                               value="1" {{ old('have_curp', 0) == 1 ? 'checked' : '' }}>
                        <label class="form-check-label"
                               for="have_curp">{{ trans('cruds.crmCustomer.fields.have_curp') }}</label>
                    </div>
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('have_rfc') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="have_rfc" id="have_rfc"
                               value="1" {{ old('have_rfc', 0) == 1 ? 'checked' : '' }}>
                        <label class="form-check-label"
                               for="have_rfc">{{ trans('cruds.crmCustomer.fields.have_rfc') }}</label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('have_had_covid') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('covid_vaccine') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('additional_comments') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('imss_number') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="imss_number" id="imss_number"
                               value="1" {{ old('imss_number', 0) == 1 ? 'checked' : '' }}>
                        <label class="form-check-label"
                               for="imss_number">{{ trans('cruds.crmCustomer.fields.imss_number') }}</label>
                    </div>
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('proof_of_residence') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="proof_of_residence"
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('highschool_diploma') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="highschool_diploma"
                               id="highschool_diploma"
                               value="1" {{ old('highschool_diploma', 0) == 1 ? 'checked' : '' }}>
                        <label class="form-check-label"
                               for="highschool_diploma">{{ trans('cruds.crmCustomer.fields.highschool_diploma') }}</label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('position') ? 'is-invalid' : '' }}"
                            name="position_id" id="position_id" required>
                        @foreach($positions as $id => $entry)
                            <option
                                value="{{ $id }}" {{ old('position_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('infonavit_credit') ? 'is-invalid' : '' }}" type="text"
                           name="infonavit_credit" id="infonavit_credit" value="{{ old('infonavit_credit', '') }}">
                ...
                <div class="form-group">
                    <div class="form-check {{ $errors->has('payment_method') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="payment_method" id="payment_method"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('how_you_knew') ? 'is-invalid' : '' }}" type="text"
                           name="how_you_knew" id="how_you_knew" value="{{ old('how_you_knew', '') }}">
