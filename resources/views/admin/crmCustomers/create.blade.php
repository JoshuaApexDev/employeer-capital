    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.crm-customers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('living_with') ? 'is-invalid' : '' }}" name="living_with" id="living_with">
                    ...
                    @foreach(App\Models\CrmCustomer::LIVING_WITH_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('living_with', 'Do you currently live with?') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('dependents') ? 'is-invalid' : '' }}" name="dependents" id="dependents">
                    ...
                    @foreach(App\Models\CrmCustomer::DEPENDENTS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('dependents', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('goal_in_life') ? 'is-invalid' : '' }}" name="goal_in_life" id="goal_in_life">{{ old('goal_in_life') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('father_age') ? 'is-invalid' : '' }}" type="number" name="father_age" id="father_age" value="{{ old('father_age', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mother_age') ? 'is-invalid' : '' }}" type="number" name="mother_age" id="mother_age" value="{{ old('mother_age', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergency_contact_relationship') ? 'is-invalid' : '' }}" type="text" name="emergency_contact_relationship" id="emergency_contact_relationship" value="{{ old('emergency_contact_relationship', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference_phone_1') ? 'is-invalid' : '' }}" type="number" name="reference_phone_1" id="reference_phone_1" value="{{ old('reference_phone_1', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference_phone_2') ? 'is-invalid' : '' }}" type="number" name="reference_phone_2" id="reference_phone_2" value="{{ old('reference_phone_2', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference_phone_3') ? 'is-invalid' : '' }}" type="number" name="reference_phone_3" id="reference_phone_3" value="{{ old('reference_phone_3', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_phone_1') ? 'is-invalid' : '' }}" type="number" name="company_phone_1" id="company_phone_1" value="{{ old('company_phone_1', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_phone_2') ? 'is-invalid' : '' }}" type="number" name="company_phone_2" id="company_phone_2" value="{{ old('company_phone_2', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('office_skills') ? 'is-invalid' : '' }}" name="office_skills" id="office_skills">{{ old('office_skills') }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('have_curp') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="have_curp" id="have_curp" value="1" {{ old('have_curp', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('have_rfc') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="have_rfc" id="have_rfc" value="1" {{ old('have_rfc', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('imss_number') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="imss_number" id="imss_number" value="1" {{ old('imss_number', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('highschool_diploma') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="highschool_diploma" id="highschool_diploma" value="1" {{ old('highschool_diploma', 0) == 1 ? 'checked' : '' }}>
