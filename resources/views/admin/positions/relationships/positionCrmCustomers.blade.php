...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-positionCrmCustomers">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-positionCrmCustomers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
